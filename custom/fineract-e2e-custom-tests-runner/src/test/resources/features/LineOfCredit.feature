...
Feature: Line Of Credit Operations
  ...
  @LOC3
  Scenario: Create client with savings and line of credit, test limit changes with balance validation
    Given A Custom EUR savings product exists
    When Admin sets the business date to "10 March 2024"
    When Admin creates a client with random data
    And Client creates a new EUR savings account with "10 March 2024" submitted on date
    And Approve EUR savings account on "10 March 2024" date
    And Activate EUR savings account on "10 March 2024" date
    When Client creates a new line of credit with start date "10 March 2024", max limit 40000 and expected available 40000
    And Line of credit is approved on "10 March 2024" with expected available 40000
    And Line of credit is activated on "10 March 2024" with expected available 40000
    And Line of credit limit is increased to 45000 on "10 March 2024" expecting available 45000
    And Line of credit limit is decreased to 42000 on "10 March 2024" expecting available 42000
    Then Line of credit status is "ACTIVE" and maximum amount is 42000
  ...
  @LOC8
  Scenario: Create receivable line of credit with 30-day tenor and a disbursement fee then complete disbursal
    Given A Custom EUR product with line of credit "receivable" loan product name "LOC Rec Pdt" with 30 days tenor exists
