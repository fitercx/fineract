...
@Slf4j
@CommandType(entity = "LINE_OF_CREDIT", action = "ADDVENDOR")
public class LineOfCreditAddVendorCommandHandler implements NewCommandSourceHandler {
    ...
    public CommandProcessingResult processCommand(JsonCommand command) {
        return this.writePlatformService.addVendor(command.entityId(), command);
    }
}
