...
@CommandType(entity = "LOC_CHARGE", action = "WAIVE")
public class LocChargeWaiveCommandHandler implements NewCommandSourceHandler {
    ...
    public CommandProcessingResult processCommand(JsonCommand command) {
        return writeService.waive(command.entityId(), command);
    }
}
