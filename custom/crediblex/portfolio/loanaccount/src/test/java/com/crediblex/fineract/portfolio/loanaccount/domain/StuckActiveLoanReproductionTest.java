 ...
 *
 * <p>
 * {@link #reproduce_baseStatusRefresh_leavesFullyPaidLoanStuckActive()} confirms the hypothesis;
 * {@link #fix_closeIfFullySettled_closesTheStuckActiveLoan()} confirms the amount-based close that the fix wires into
 * those paths resolves it.
 */
