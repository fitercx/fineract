...
public class CredXInterestPrincipalPenaltyFeesOrderLoanRepaymentScheduleTransactionProcessor
        extends InterestPrincipalPenaltyFeesOrderLoanRepaymentScheduleTransactionProcessor {

    private final LpiSameMonthProperties lpiSameMonthProperties;

    public CredXInterestPrincipalPenaltyFeesOrderLoanRepaymentScheduleTransactionProcessor(ExternalIdFactory externalIdFactory,
