...
@AllArgsConstructor
public class CredXLoanRescheduleRequestDataValidator implements LoanRescheduleRequestDataValidator {
    ...
    private static void validateMultiDisburseLoan(Loan loan, DataValidatorBuilder dataValidatorBuilder) {
        if (loan.isMultiDisburmentLoan() && !loan.loanProduct().isDisallowExpectedDisbursements()) {
        ...
        if (installment != null) {
            ...
            for (LoanCharge loanCharge : charges) {
                if (loanCharge.isActive() && loanCharge.isOverdueInstallmentCharge()
                        ...
                        && loanCharge.getAmountOutstanding(loan.getCurrency()).plus(loanCharge.getTaxAmountOutstanding(loan.getCurrency()))
                                .isGreaterThanZero()) {
