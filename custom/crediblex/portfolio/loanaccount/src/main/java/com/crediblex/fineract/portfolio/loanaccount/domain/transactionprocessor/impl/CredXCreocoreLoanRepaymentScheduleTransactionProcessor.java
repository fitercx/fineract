...
public class CredXCreocoreLoanRepaymentScheduleTransactionProcessor extends CreocoreLoanRepaymentScheduleTransactionProcessor {

    private final LpiSameMonthProperties lpiSameMonthProperties;

    public CredXCreocoreLoanRepaymentScheduleTransactionProcessor(ExternalIdFactory externalIdFactory,
