...
public class CredXPrincipalInterestPenaltyFeesOrderLoanRepaymentScheduleTransactionProcessor
        extends PrincipalInterestPenaltyFeesOrderLoanRepaymentScheduleTransactionProcessor {

    private final LpiSameMonthProperties lpiSameMonthProperties;

    public CredXPrincipalInterestPenaltyFeesOrderLoanRepaymentScheduleTransactionProcessor(ExternalIdFactory externalIdFactory,
