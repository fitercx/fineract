...
@Primary
@Service
public class CredXPermissionReadPlatformServiceImpl extends PermissionReadPlatformServiceImpl {

    private final PlatformSecurityContext platformSecurityContext;
    private final SuperUserAdministrationAuthorizationService superUserAdministrationAuthorizationService;

    public CredXPermissionReadPlatformServiceImpl(final PlatformSecurityContext context, final JdbcTemplate jdbcTemplate,
        ...
        super(context, jdbcTemplate, sqlGenerator);
