...
public class OdooJournalEntryService {
    ...
    public Long postJournalEntryToOdoo(JournalEntry fineractEntry) {
        try {
            ...
            log.info("Successfully posted Fineract journal entry {} to Odoo as move {}", 
                fineractEntry.getId(), odooMoveId);
    ...
    /**
     * Build move lines for the journal entry
     * This creates balanced debit and credit entries
     */
    private List<Object> buildMoveLines(JournalEntry fineractEntry, Integer accountId) {
        ...
        if (isDebit) {
            ...
            debitLine.put("name", fineractEntry.getDescription() != null ? 
                fineractEntry.getDescription() : "Haider Journal Entry");
            ...
            creditLine.put("name", "Balancing entry for " + 
                (fineractEntry.getDescription() != null ? fineractEntry.getDescription() : "Haider JE"));
            ...
            creditLine.put("debit", BigDecimal.ZERO);
            creditLine.put("credit", amount);
            creditLine.put("name", fineractEntry.getDescription() != null ? 
                fineractEntry.getDescription() : "Haider Journal Entry");
            ...
            debitLine.put("debit", amount);
            debitLine.put("credit", BigDecimal.ZERO);
            debitLine.put("name", "Balancing entry for " + 
                (fineractEntry.getDescription() != null ? fineractEntry.getDescription() : "Haider JE"));
    ...
    /**
     * Get balancing account ID
     * This is a simplified implementation - you should implement proper logic
     * based on your chart of accounts and business rules
     */
