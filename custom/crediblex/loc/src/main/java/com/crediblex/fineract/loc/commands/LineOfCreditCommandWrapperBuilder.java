...
package com.crediblex.fineract.loc.commands;

import org.apache.fineract.commands.service.CommandWrapperBuilder;

public class LineOfCreditCommandWrapperBuilder extends CommandWrapperBuilder {
    ...
    public LineOfCreditCommandWrapperBuilder drawLineOfCreditAmount(final Long lineOfCreditId) {
        this.actionName = "DRAW";
        this.entityName = "LINE_OF_CREDIT";
        this.entityId = lineOfCreditId;
        this.href = "/v1/lineofcredit/" + lineOfCreditId + "/draw";
        return this;
    }

    public LineOfCreditCommandWrapperBuilder repayLineOfCreditAmount(final Long lineOfCreditId) {
        this.actionName = "REPAY";
        this.entityName = "LINE_OF_CREDIT";
        this.entityId = lineOfCreditId;
        this.href = "/v1/lineofcredit/" + lineOfCreditId + "/repay";
        return this;
    }
} 