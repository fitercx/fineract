...
public class LoanRepaymentScheduleInstallment extends AbstractAuditableWithUTCDateTimeCustom<Long>
    ...
    @Column(name = "credited_tax", scale = 6, precision = 19)
    private BigDecimal creditedTax;
    ...
    public Money getCreditedTax(final MonetaryCurrency currency) {
        return Money.of(currency, this.creditedTax);
    }
    ...
    public void addToChargePortion(final Money feeChargesDue, final Money feeChargesWaived, final Money feeChargesWrittenOff,
        ...
        this.taxChargesWrittenOff = MathUtil.zeroToNull(MathUtil.add(MathUtil.toBigDecimal(taxChargesWrittenOff), this.taxChargesWrittenOff));
