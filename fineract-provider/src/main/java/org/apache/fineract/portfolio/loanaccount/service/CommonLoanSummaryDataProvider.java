...
public abstract class CommonLoanSummaryDataProvider implements LoanSummaryDataProvider {
    ...
    public LoanSummaryData withTransactionAmountsSummary(Loan loan, LoanSummaryData defaultSummaryData, LoanScheduleData repaymentSchedule,
        ...
        return LoanSummaryData.builder().currency(defaultSummaryData.getCurrency())
                ...
                .taxChargesCharged(defaultSummaryData.getTaxChargesCharged()).taxChargesPaid(defaultSummaryData.getTaxChargesPaid())
                .taxChargesWaived(defaultSummaryData.getTaxChargesWaived())
                .taxChargesWrittenOff(defaultSummaryData.getTaxChargesWrittenOff())
                .taxChargesOutstanding(defaultSummaryData.getTaxChargesOutstanding())
                .taxChargesOverdue(defaultSummaryData.getTaxChargesOverdue()).taxAdjustments(defaultSummaryData.getTaxAdjustments())
